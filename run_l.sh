...
#python demo_light.py --audio_feature LogMelFBank --train_batch_size 64 --lr 1e-3 --patience 25 --window_length 1024 --hop_length 512 --number_mels 64 --num_epochs 150 -numBins 16 -RR 64 --sample_rate 16000 --segment_length 5 --data_selection 1 --histograms_shared --adapters_shared --train_mode histogram --adapter_location None --adapter_mode None --histogram_location mhsa --histogram_mode parallel
