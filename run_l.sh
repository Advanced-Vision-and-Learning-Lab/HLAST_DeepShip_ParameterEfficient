...
python demo_light.py --audio_feature LogMelFBank --train_batch_size 64 --lr 1e-3 --num_worker 8 --patience 20 --window_length 2048 --hop_length 512 --number_mels 128 --num_epochs 1 -numBins 16 -RR 64 --sample_rate 16000 --segment_length 5 --data_selection 0 --histograms_shared --adapters_shared --train_mode lora --lora_target q --lora_rank 6 --no-lora_shared

python demo_light.py --audio_feature LogMelFBank --train_batch_size 64 --lr 1e-3 --num_worker 8 --patience 20 --window_length 2048 --hop_length 512 --number_mels 128 --num_epochs 1 -numBins 16 -RR 64 --sample_rate 16000 --segment_length 5 --data_selection 0 --histograms_shared --adapters_shared --train_mode lora --lora_target qv --lora_rank 6 --no-lora_shared

python demo_light.py --audio_feature LogMelFBank --train_batch_size 64 --lr 1e-3 --num_worker 8 --patience 20 --window_length 2048 --hop_length 512 --number_mels 128 --num_epochs 1 -numBins 16 -RR 64 --sample_rate 16000 --segment_length 5 --data_selection 0 --histograms_shared --adapters_shared --train_mode lora --lora_target q --lora_rank 6 --lora_shared

#python demo_light.py --audio_feature LogMelFBank --train_batch_size 64 --lr 1e-3 --num_worker 8 --patience 20 --window_length 2048 --hop_length 512 --number_mels 128 --num_epochs 1 -numBins 16 -RR 64 --sample_rate 16000 --segment_length 5 --data_selection 1 --histograms_shared --adapters_shared --train_mode bias --adapter_location None --adapter_mode None --histogram_location None --histogram_mode None
...
#python demo_light.py --audio_feature LogMelFBank --train_batch_size 64 --lr 1e-3 --num_worker 8 --patience 20 --window_length 2048 --hop_length 512 --number_mels 128 --num_epochs 200 -numBins 16 -RR 64 --sample_rate 16000 --segment_length 5 --data_selection 0 --histograms_shared --adapters_shared --train_mode histogram --adapter_location None --adapter_mode None --histogram_location mhsa --histogram_mode parallel
