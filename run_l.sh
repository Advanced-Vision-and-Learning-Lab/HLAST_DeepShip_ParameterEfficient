...
python demo_light.py --audio_feature LogMelFBank --train_batch_size 64 --lr 1e-3 --num_worker 8 --patience 20 --window_length 2048 --hop_length 512 --number_mels 128 --num_epochs 30 -numBins 16 -RR 64 --sample_rate 16000 --segment_length 5 --data_selection 1 --histograms_shared --adapters_shared --train_mode lora --lora_target qv --lora_rank 12 --no-lora_shared
