...
#python esc_demo_light.py --audio_feature LogMelFBank --train_batch_size 64 --lr 1e-5 --patience 10 --window_length 4096 --hop_length 512 --number_mels 128 --num_epochs 1 -numBins 8 --sample_rate 16000 --histograms_shared --no-adapters_shared --histogram --train_mode linear_probing --adapter_location None --adapter_mode None --histogram_location mhsa --histogram_mode parallel
...
python esc_demo_light.py --audio_feature LogMelFBank --train_batch_size 64 --lr 1e-5 --patience 10 --window_length 4096 --hop_length 512 --number_mels 128 --num_epochs 150 -numBins 8 --sample_rate 16000 --no-histograms_shared --no-adapters_shared --histogram --train_mode linear_probing --adapter_location None --adapter_mode None --histogram_location mhsa --histogram_mode sequential
